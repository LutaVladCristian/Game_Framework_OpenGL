...
bool Maze_Runner_3D::collisionPlayerWall(glm::vec3 direction)
{
...
void Maze_Runner_3D::SetMaze(cell matrix[5][5])
{
    stack <cell> stack;
    int random = -1;
    int start_row = 2;
...
void Maze_Runner_3D::Init()
{
    ...
    // Load textures
    const string sourceTextureDir = PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Maze_Runner_3D", "textures");
    {
    ...
    // Create a shader program
    {
        ...
        shader->AddShader(PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Maze_Runner_3D", "shaders", "VertexShaderMaze.glsl"), GL_VERTEX_SHADER);
        shader->AddShader(PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Maze_Runner_3D", "shaders", "FragmentShaderMaze.glsl"), GL_FRAGMENT_SHADER);
...

    {
        ...
        shader->AddShader(PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Maze_Runner_3D", "shaders", "VertexShaderPlayer.glsl"), GL_VERTEX_SHADER);
        shader->AddShader(PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Maze_Runner_3D", "shaders", "FragmentShaderPlayer.glsl"), GL_FRAGMENT_SHADER);
        shader->CreateAndLink();
        shaders[shader->GetName()] = shader;
    }

    {
        ...
        shader->AddShader(PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Maze_Runner_3D", "shaders", "VertexShaderEnemy.glsl"), GL_VERTEX_SHADER);
        shader->AddShader(PATH_JOIN(window->props.selfDir, SOURCE_PATH::M1, "Maze_Runner_3D", "shaders", "FragmentShaderEnemy.glsl"), GL_FRAGMENT_SHADER);
        shader->CreateAndLink();
        shaders[shader->GetName()] = shader;
    }
...
void Maze_Runner_3D::FrameStart()
{
...
void Maze_Runner_3D::Update(float deltaTimeSeconds)
{
...
void Maze_Runner_3D::FrameEnd()
{
    //DrawCoordinateSystem(camera->GetViewMatrix(), projectionMatrix);
}


void Maze_Runner_3D::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, Texture2D* texture1)
{
...
void Maze_Runner_3D::OnInputUpdate(float deltaTime, int mods)
{
...
void Maze_Runner_3D::OnKeyPress(int key, int mods)
{
    if (key == GLFW_KEY_R)
        switch (renderPlayer)
        {
...
void Maze_Runner_3D::OnKeyRelease(int key, int mods)
{
}


void Maze_Runner_3D::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
...
void Maze_Runner_3D::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
}


void Maze_Runner_3D::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
}


void Maze_Runner_3D::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
}


void Maze_Runner_3D::OnWindowResize(int width, int height)
{
}
