...
glm::mat3 Gunner_2D::VisualizationTransf2DUnif(const LogicSpace& logicSpace, const ViewportSpace& viewSpace)
{
...
void Gunner_2D::SetViewportArea(const ViewportSpace& viewSpace, glm::vec3 colorColor, bool clear)
{
...
void Gunner_2D::DrawScene(glm::mat3 visMatrix)
{
    //player
    if (health > 0)
    {
...
void Gunner_2D::DrawScene2(glm::mat3 visMatrix)
{
    //player
    if (health > 0)
    {
...
void Gunner_2D::Update(float deltaTimeSeconds)
{
    glm::ivec2 resolution = window->GetResolution();
    logicSpace.x = cx;
    logicSpace.y = cy;
...
void Gunner_2D::FrameEnd()
{
}


void Gunner_2D::OnInputUpdate(float deltaTime, int mods)
{
...
void Gunner_2D::OnKeyPress(int key, int mods)
{

}


void Gunner_2D::OnKeyRelease(int key, int mods)
{
}


void Gunner_2D::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
...
void Gunner_2D::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
    if (button == 1)
    {
        cursorX = mouseX;
...
void Gunner_2D::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
}


void Gunner_2D::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
}


void Gunner_2D::OnWindowResize(int width, int height)
{
}
